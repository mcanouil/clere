# Getting help with clere

Thanks for using clere. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/mcanouil/clere/issues) to make sure the 
