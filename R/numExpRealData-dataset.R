...
#' 
#' 
#' @name numExpRealData-dataset
#' @aliases numExpRealData numExpRealData-dataset
#' @docType data
...
#' \code{\linkS4class{Clere}}, \code{\linkS4class{Pacs}} \cr Functions :
#' \code{\link{fitClere}}, \code{\link{fitPacs}} \cr Datasets :
#' \code{\link{numExpSimData}}, \code{\link{numExpRealData}},
#' \code{\link{algoComp}}
#' 
NULL
